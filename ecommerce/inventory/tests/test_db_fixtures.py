...
# fixture test for inventory.category table
...
# testing of the inventory.category table
...
# Testing of the inventory.product table


@pytest.mark.dbfixture
@pytest.mark.parametrize(
    # we are excluding category field
...
def test_inventory_db_product_dbfixture(
    ...
    assert result.is_active == is_active
    assert result_updated_at == created_at
